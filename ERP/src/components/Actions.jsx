    ...
    return (
        <>
            <div className="flex justify-between items-center gap-3">
                ...
                {editRoute !== "review" ? (
                    <Link to={`/admin/${editRoute}/${id}`} className="text-blue-600 hover:bg-blue-200 p-1 rounded-full ">
                        <EditIcon />
                    </Link>
                ) : (
                    null
                    ...
                    <button onClick={() => setOpen(true)} className="text-red-600 hover:bg-red-200 p-1 rounded-full ">
                        <DeleteIcon />
                    </button>
